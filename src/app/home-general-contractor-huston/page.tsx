...
export default function HomePage() {
    ...
    useEffect(() => {
        document.title = "General Contractor Network in Houston | EZ Subcontractor";
        const metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute(
                'content',
                'The trusted platform for general contractors in Houston to connect with verified subcontractors, post projects, and win bids faster. Free trial available.'
            );
        } else {
