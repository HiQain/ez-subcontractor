...
export default function HomePage() {
    ...
    useEffect(() => {
        document.title = "General Contractor Network in New York | EZ Subcontractor";
        const metaDescription = document.querySelector('meta[name="description"]');
        if (metaDescription) {
            metaDescription.setAttribute(
                'content',
                'The trusted platform for general contractors in New York to connect with verified subcontractors, post projects, and win bids faster. Free trial available.'
            );
        } else {
    ...
    const processSteps = [
        {
            ...
            description:
                'We start by understanding your project goals, workflow gaps, and delivery priorities so we can shape a clear execution strategy.',
            image: '/assets/img/home-banner-img1.webp',
            alt: 'Discovery and strategy planning',
        },
        {
            id: 2,
            title: 'UI/UX Design & Wireframes',
            description:
                'We translate your ideas into practical wireframes and user-focused layouts, helping your team review and align before development begins.',
            image: '/assets/img/home-banner-img2.webp',
            alt: 'UI and wireframe planning',
        },
        {
            id: 3,
            title: 'Agile Development Cycles',
            description:
                'Your solution is built in agile sprints, with rapid progress updates and feedback loops to keep delivery on track and transparent.',
            image: '/assets/img/home-banner-img3.webp',
            alt: 'Agile product development',
        },
        {
            id: 4,
            title: 'Testing, Launch & Support',
            description:
                'Before launch, we verify performance and stability, then provide post-launch support to keep your platform secure and reliable.',
            image: '/assets/img/home-banner-img4.webp',
            alt: 'Testing and support services',
        },
    ];
    ...
    const serviceReasons = [
        {
            id: 1,
            icon: '/assets/img/service/main-service-icon (1).webp',
            title: 'Centralized Admin Control',
            description:
                'Manage users, permissions, files, and project communication through one organized workspace designed for teams.',
        },
        {
            id: 2,
            icon: '/assets/img/service/main-service-icon (2).webp',
            title: 'Customization & Collaboration',
            description:
                'Flexible modules and collaboration flows help teams work faster across departments with better visibility.',
        },
        {
            id: 3,
            icon: '/assets/img/service/main-service-icon (3).webp',
            title: 'Ease Of Use',
            description:
                'A clean interface and intuitive navigation make adoption easier for both technical and non-technical team members.',
        },
        {
            id: 4,
            icon: '/assets/img/service/main-service-icon (4).webp',
            title: 'Security',
            description:
                'Role-based access, controlled permissions, and secure workflows help protect sensitive project and client information.',
        },
        {
            id: 5,
            icon: '/assets/img/service/main-service-icon (5).webp',
            title: 'Popularity',
            description:
                'Trusted collaboration patterns and scalable workflows make this model practical for growing contractor operations.',
        },
        {
            id: 6,
            icon: '/assets/img/service/main-service-icon (6).webp',
            title: 'Cost Efficiency',
            description:
                'Reduce operational overhead by centralizing communication, task updates, and project coordination in one place.',
        },
    ];
    ...
    return (
        <div>
            ...
            <section className="gc2-process-sec py-5">
                <div className="container">
                    <div className="gc2-section-head text-center mx-auto">
                        <h2 className="fw-bold mb-2">Our Proven Process at NGS Solution</h2>
                        <p className="gc2-accent mb-0">From Concept to Completion</p>
                    </div>

                    <div className="gc2-process-list">
                        {processSteps.map((step, index) => {
                            const reverse = index % 2 !== 0;

                            return (
                                <div key={step.id} className="row g-4 g-lg-5 align-items-center gc2-process-item">
                                    <div className={`col-lg-5 ${reverse ? 'order-lg-2' : ''}`}>
                                        <div className="gc2-process-image-wrap">
                                            <Image
                                                src={step.image}
                                                alt={step.alt}
                                                fill
                                                className="gc2-process-image"
                                    ...
                                    <div className={`col-lg-7 ${reverse ? 'order-lg-1' : ''}`}>
                                        <div className="gc2-process-content">
            ...
            <section className="gc2-services-sec py-5">
                <div className="container">
                    <div className="gc2-section-head text-center mx-auto">
                        <h2 className="fw-bold mb-2">Reasons To Opt For SharePoint Services</h2>
                        <p className="text-muted mb-0">
                            Strong collaboration, secure control, and scalable workflows built to support modern project teams.
                        </p>
                    </div>
                    ...
                    <div className="gc2-expertise-box">
                        <div className="row g-4 align-items-center">
                            <div className="col-lg-4">
                                <div className="gc2-expertise-image-wrap">
                                    <Image
                                        src="/assets/img/about-section.webp"
                                        alt="Best in class implementation expertise"
                                        fill
                                        className="gc2-expertise-image"
                            ...
                            <div className="col-lg-8">
                                <h3 className="fw-bold mb-3">Best-In-Class SharePoint Expertise</h3>
                                <p className="text-muted mb-3">
                                    We combine practical development experience with scalable architecture decisions, so teams can launch faster and maintain long-term performance.
                                </p>
                                <p className="text-muted mb-0">
                                    From design and migration to custom workflow implementation, our focus stays on dependable delivery and measurable business impact.
                                </p>
                            </div>
                        </div>
                    </div>
